...
public class InterfazLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSalir.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 12)); // NOI18N
        btnSalir.setText("Salir");
        btnSalir.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(0, 0, 0), new java.awt.Color(0, 0, 0), new java.awt.Color(0, 0, 0)));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        String Codigo = txtCodigo.getText() ; //Obtener codigo
        String Contraseña = txtContraseña.getText(); //Obtener contrasena
        
        if(Codigo.isEmpty() || Contraseña.isEmpty()){ //Condicional por si estan vacios los campos
